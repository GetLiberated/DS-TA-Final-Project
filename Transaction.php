...
<body>
        ...
        <?php
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    echo "<tr><td><form action=\"\" method=\"GET\"><input type=\"hidden\" name=\"id\" value=\"" . $row["transactionID"] . "\"><input class=\"delete\" type=\"submit\" value=\"-\"></form></td><td>" . $row["total"]. "</td><td>" . $row["restaurantID"]."</td><td>" . $row["staffID"]."</td></tr>";
                }
                // echo "</table>";
    ...
    <form action="" method="GET" id="insertForm" style="visibility: hidden;">
        <table id="inserTable">
            <tr>
                <th></th>
                <th><input type="number" name="total" required></th>
                <th><input type="number" name="restaurantID" required></th>
                <th><input type="number" name="staffID" required></th>
