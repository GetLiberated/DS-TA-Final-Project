        ...
        <?php
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    echo "<tr><td><form action=\"\" method=\"GET\"><input type=\"hidden\" name=\"transactionDetailID\" value=\"" . $row["transactionDetailID"] . "\"><input class=\"delete\" type=\"submit\" value=\"-\"></form></td><td>" . $row["itemID"]. "</td><td>" . $row["transactionID"]. "</td><td>" . $row["quantity"]."</td></tr>";
                }
                // echo "</table>";
